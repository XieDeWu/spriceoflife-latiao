...
public class Config {
    ...
    public static final ModConfigSpec.ConfigValue<String> HUNGER = BUILDER
        .comment("默认饱食度公式，影响顺序：短期饮食、饥饿程度、长期饮食 ||| 相关变量 该食物饱食度 HUNGER 该食物短期食用次数 EATEN_SHORT 玩家饱食度 HUNGER_LEVEL 该食物长期食用次数 EATEN_LONG")
    ...
    public static final ModConfigSpec.ConfigValue<String> SATURATION = BUILDER
        .comment("默认饱和度公式,影响顺序：短期饮食、长期饮食、饥饿程度 ||| 相关变量 该食物饱和度 SATURATION 该食物短期食用次数 EATEN_SHORT 该食物长期食用次数 EATEN_LONG 玩家饱食度 HUNGER_LEVEL")
